 ...
 *   To increase performance of imageCars on iOS, cache your imageCars in advance and,
 *   if possible, lower the number of unique imageCars. We're working on [a solution](https://github.com/driftyco/ionic/issues/3194).
 *
 * @usage
 ...
 *   items in the list. Default 3. Tip: set this higher if you have lots of imageCars to preload, but
 *   don't set it too high or you'll see performance loss.
 * @param {boolean=} force-refresh-imageCars Force imageCars to refresh as you scroll. This fixes a problem
